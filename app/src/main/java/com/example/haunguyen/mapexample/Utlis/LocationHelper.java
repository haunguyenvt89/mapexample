...
import com.example.haunguyen.mapexample.Map.LocationHelperListener;
...
public class LocationHelper extends Service implements LocationListener {
    ...
    public void setTimeRequest(long time){
        timeRequest = time * MIN_TIME_BW_UPDATES;
...
//            locationManager.removeUpdates(this);
            locationHelperListener.onLocationChange(location);
            Log.d("locationHelper", System.currentTimeMillis()+"");
        }
    ...
    public void onProviderDisabled(String provider) {
        locationManager.removeUpdates(this);
        locationHelperListener.onProviderDisable();
    }

    @Override
    public void onProviderEnabled(String provider) {
        locationHelperListener.onProviderEnable();
    }
